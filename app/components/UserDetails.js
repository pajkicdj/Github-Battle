...
UserDetails.propTypes = {
  ...
  info: PropTypes.shape({
    ...
    blog: PropTypes.string,  //not required because github didn't make it a mandatory field and sometimes data might be missing
...
//shape = allows you to have proptypes based on certain key values